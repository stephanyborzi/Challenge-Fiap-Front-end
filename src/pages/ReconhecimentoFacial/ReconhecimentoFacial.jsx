...
const ReconhecimentoFacial = () => {
    ...
    const [uncadastredEmployees] = useState([
        'Alice Souza',
        'Bruno Costa',
        'Carla Dias',
        'Eduardo Mendes',
                ...
                <div className="reconhecimento-content">
                    <div className="recognition-area">
                        <div className={`camera-view ${status}`}>
                            <div className={`face-circle ${status}`}>
                                <i className="fas fa-user face-icon"></i>
                            </div>
                            <p className="camera-instruction">{statusMessage}</p>
                        </div>
                        <div className="action-buttons">
                            {lastResult === null ? (
                                <button className="capture-button" onClick={handleStartCapture} disabled={status === 'capturing' || status === 'processing'}>
